...
| T08a | P3 | 独立指摘の PID 所有者・履歴清掃・上限・終了観測・監査 | T07 | L | MVP-IFR-001〜005 の製品修正と指定された組合せ試験を確認 | 残存002・004の補修と全23件合格、限定確認待ち |
...
| T08d | P3 | Windows ファイル識別番号の精度保持 | T08a | M | bigint 由来の損失のない識別、manifest 検証、設定・転送の衝突回帰が合格 | 修正と全23件合格、限定確認待ち |
| T08 | P3 | 独立最終レビューと PR 更新 | T07,T08a,T08b,T08c,T08d | M | 別 reviewer による確認、コミット、push、PR に証拠と未検証範囲を記載 | 独立初回 fail、修正後の全検証・限定レビュー待ち |
