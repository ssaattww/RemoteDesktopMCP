...
| F03 | P4 | 単一 PC の Tailscale Funnel と ChatGPT 公開接続検証 | F01,F01a,F01b | M | 実際の公開経路から認証と操作、再起動後の接続を確認 | 実設定済み、コードの通常指摘解消後に公開起動 |
| F04 | P4 | 公開接続の通常・独立レビュー | F01a,F01b | M | Sol / high で公開用変更を確認し、F03 の実運用結果と未検証事項を区別 | a083430 の修正確認は incomplete。REMOTE-NR-002/003/006/008 の不足を修正中、他5件は予備確認済み |
