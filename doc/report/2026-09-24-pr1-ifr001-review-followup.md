...
- technical HEAD: `3a66f444a91e05f1667a7ca258c377679b23fbfc`
...
- `npm run lint`: pass
- markdownlint: 23 files / 0 issues
...
report / handoff を追加した publication 候補でも `npm run lint` は
24 files / 0 issues で pass した。
